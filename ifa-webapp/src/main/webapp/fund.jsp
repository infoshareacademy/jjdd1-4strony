...
<div class="container-fluid">
    <div class="col-md-10 col-md-offset-1 main">
        <div class="row">
            <h3 class="page-header">${investFund.name}</h3>
        ...
        <div class="row main">
            ...
            <form method="get" action="/4analysis/${investFund.id}">
                    ...
                    <div class="row">
                        <div class="col-md-2 box">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="from" value="${from}" class="form-control" placeholder="od">
                            </div>
                        </div>
                        <div class="col-md-2 box">
                            <label>do</label>
